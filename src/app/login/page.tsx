...
function LoginForm() {
  ...
  return (
    <div className="flex min-h-screen bg-brand-cream">
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-brand-orange via-brand-orange/90 to-brand-teal lg:flex lg:w-1/2">
            ...
            <div className="flex items-center gap-4">
              <div className="flex -space-x-3">
                {[1, 2, 3].map(i => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-2 border-white bg-gradient-to-br from-brand-teal to-brand-orange"
                  />
                ))}
              </div>
              <div>
