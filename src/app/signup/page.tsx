...
export default function SignupPage() {
          ...
          <div className="rounded-3xl border-2 border-brand-slate/10 bg-white p-8 text-center shadow-xl">
            ...
            <p className="mb-8 text-brand-slate/70">
              {requiresEmailConfirmation ? (
                ...
                <>
                  ...
                  <span className="font-semibold text-brand-teal">Buyer</span>
                </>
              )}
            </p>
            ...
            {requiresEmailConfirmation ? (
              ...
              <>
                ...
                <div className="rounded-2xl border-2 border-brand-teal/20 bg-gradient-to-br from-brand-teal/10 to-brand-teal/5 p-6 text-left">
                  <div className="flex gap-3">
                    <Info className="mt-0.5 h-5 w-5 flex-shrink-0 text-brand-teal" />
  ...
  return (
    <div className="flex min-h-screen bg-brand-cream">
        ...
        >
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="rounded-2xl border-2 border-brand-slate/10 bg-gradient-to-br from-brand-cream to-brand-orange/5 p-4 text-sm text-brand-slate/70">
              <p className="mb-1">
                • New accounts start as <span className="font-semibold text-brand-teal">Buyer</span>{' '}
                role
              </p>
              <p>
      ...
      <div className="relative hidden overflow-hidden bg-gradient-to-br from-brand-teal via-brand-teal/90 to-brand-orange lg:flex lg:w-1/2">
            ...
            <div className="flex items-center gap-4 border-t border-white/20 pt-4">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map(i => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-2 border-white bg-gradient-to-br from-brand-orange to-brand-teal"
                  />
                ))}
              </div>
              <div>
