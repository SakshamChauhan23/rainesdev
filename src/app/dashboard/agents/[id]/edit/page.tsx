    ...
    return (
        <Container className="max-w-3xl py-12">
            ...
            {(agent.status === 'UNDER_REVIEW' || agent.status === 'APPROVED') && (
                <div className="mb-6 rounded-lg bg-blue-50 border border-blue-200 p-4 text-blue-900">
                    <p className="font-semibold mb-2">Editing Disabled</p>
                    <p className="text-sm">
            ...
            {agent.demoVideoUrl && (
                <div className="mb-6">
                    <h2 className="text-lg font-semibold mb-3">Current Demo Video</h2>
