    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <Container className="py-12">
        ...
        {searchParams?.success === 'created' && (
          <div className="mb-8 animate-fade-in rounded-3xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-green-100/50 p-6 shadow-lg">
          ...
          {agents.length === 0 ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3">
              {agents.map(agent => (
                <div
                  key={agent.id}
                  className="group relative overflow-hidden rounded-2xl border-2 border-brand-slate/10 bg-white shadow-lg transition-all hover:-translate-y-1 hover:border-brand-teal/30 hover:shadow-xl sm:rounded-3xl"
                >
                  {/* Thumbnail */}
                  {agent.thumbnailUrl && (
                  ...
                  <div className="p-4 sm:p-6">
                    ...
                    <div className="flex gap-2 border-t-2 border-brand-slate/10 pt-3 sm:pt-4">
                      <Button
                        variant="outline"
                        size="sm"
                        className="flex-1 rounded-xl border-2 hover:border-brand-teal hover:bg-brand-teal/5"
                        asChild
                      >
