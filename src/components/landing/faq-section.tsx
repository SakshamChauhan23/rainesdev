                    ...
                    >
                      <span
                        className={`text-lg font-semibold transition-colors ${
                          isOpen
                            ? 'text-brand-orange'
                            : 'text-brand-slate group-hover:text-brand-teal'
                        }`}
                      >
                        {faq.question}
                      </span>
          ...
          >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-6">
              <a
                ...
                className="rounded-xl bg-white px-6 py-3 font-semibold text-brand-orange shadow-lg transition-all hover:scale-105 hover:shadow-xl"
              >
                Contact Support
              </a>
              <a
                href="/about"
                className="rounded-xl border-2 border-white bg-transparent px-6 py-3 font-semibold text-white transition-all hover:bg-white hover:text-brand-orange"
              >
                View Documentation
              </a>
            </div>
