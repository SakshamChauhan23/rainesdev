...
import { MessageSquare, TrendingUp, BarChart3, FileText, Code, Zap, ArrowRight } from 'lucide-react'
...
const categoryDefinitions = [
  {
    ...
    description:
      'Handle FAQs, tickets, and follow-ups automatically — 24/7 support without hiring.',
    icon: MessageSquare,
    color: 'orange',
  },
  {
  ...
  },
  {
    ...
    description:
      'Create emails, website copy, and social posts consistently without an in-house marketer.',
    icon: FileText,
    color: 'teal',
  },
  {
  ...
  },
  {
    ...
    slug: 'productivity',
    description:
      'Scheduling, reminders, task routing, and internal coordination handled automatically.',
    icon: Zap,
    color: 'teal',
  },
]
  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-28 lg:py-32">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute left-1/4 top-0 h-full w-px bg-gradient-to-b from-transparent via-brand-orange/10 to-transparent" />
      </div>
                  ...
                  <div className="flex items-center justify-between border-t-2 border-brand-slate/10 pt-4">
                    <div
                      className={`flex items-center gap-2 text-sm font-semibold ${
                        isOrange ? 'text-brand-orange' : 'text-brand-orange'
                      }`}
                    >
                      <span>{count}</span>
