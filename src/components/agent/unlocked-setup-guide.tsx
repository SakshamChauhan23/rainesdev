    ...
    return (
        <section id="setup-guide" className="mt-12">
            <Card className="border-green-200 bg-green-50/30">
                ...
                <CardContent>
                    <div className="prose prose-sm max-w-none prose-headings:font-normal prose-headings:text-gray-900 prose-p:font-light prose-p:text-gray-700 dark:prose-invert">
