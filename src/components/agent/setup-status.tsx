...
export function SetupStatus({ status, setupCost, completedAt, adminNotes }: SetupStatusProps) {
  ...
  return (
    <Card
      className={`p-6 ${isPending ? 'border-2 border-brand-orange/30 bg-brand-orange/5' : 'border-2 border-brand-orange/30 bg-brand-orange/5'}`}
    >
      <div className="flex items-start gap-4">
        <div
          className={`flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl ${isPending ? 'bg-orange-100' : 'bg-brand-orange/10'}`}
        >
          {isPending ? (
        ...
        <div className="flex-1 space-y-3">
          <div className="flex items-start justify-between">
            <div>
              <div className="mb-1 flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold text-gray-900">Admin-Assisted Setup</h3>
              </div>
            ...
            <Badge
              className={isPending ? 'bg-orange-600 text-white' : 'bg-brand-orange text-white'}
            >
          ...
          {isPending ? (
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-700">
                You&apos;ll receive a notification once your agent has been configured and connected
                to your tools. We&apos;ll email you when the setup is complete.
              </p>
            ...
            <div className="space-y-2">
              ...
              {adminNotes && (
                <div className="mt-3 rounded-lg border border-brand-orange/20 bg-white p-3">
                  <p className="mb-1 text-xs font-semibold text-gray-700">Setup Notes:</p>
