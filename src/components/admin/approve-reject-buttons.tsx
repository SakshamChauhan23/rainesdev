  ...
  return (
    <div className="flex gap-3">
      ...
      <Button
        ...
        className="flex-1 bg-brand-orange hover:bg-brand-orange"
        disabled={isPending}
      >
        {isPending ? (
          <Loader2 className="mr-2 h-4 w-4 animate-spin" />
      ...
      <Dialog open={rejectDialogOpen} onOpenChange={setRejectDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a clear reason for rejecting &quot;{agentTitle}&quot;. The seller will
              see this message and can resubmit after making changes.
            </DialogDescription>
          </DialogHeader>
