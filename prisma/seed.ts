...
async function main() {
  ...
  // Open Source Agents from CSV - $14.99 each with featured images
  const openSourceAgents = [
    {
      title: 'SuperAGI',
      slug: 'superagi',
      shortDescription:
        'Dev-first open source autonomous AI agent framework for building, managing & running agents',
      workflowOverview:
        'SuperAGI provides a comprehensive framework for developers to create autonomous AI agents. It includes tools for agent management, execution monitoring, and integration with various AI models.',
      useCase:
        'Build custom autonomous agents that can handle complex multi-step tasks, integrate with external tools, and maintain persistent memory across sessions.',
    ...
    },
    {
      ...
      slug: 'agent-zero',
      shortDescription:
        'General-purpose assistant with persistent memory, fully transparent and customizable',
      workflowOverview:
        'Agent Zero is designed as a transparent, customizable AI assistant that maintains context across conversations through persistent memory storage.',
      useCase:
        'Create a personal AI assistant that remembers your preferences, past conversations, and can be fully customized to your specific needs.',
      categorySlug: 'autonomous-agents',
      thumbnailUrl:
    ...
    },
    {
      ...
      slug: 'autogpt',
      shortDescription:
        'Powerful platform for creating, deploying, and managing continuous AI agents',
      workflowOverview:
        'AutoGPT is one of the pioneering autonomous agent platforms, allowing GPT-4 to run autonomously with goal-oriented task completion.',
      useCase:
        'Deploy AI agents that can browse the web, execute code, manage files, and complete complex multi-step objectives with minimal human intervention.',
      categorySlug: 'autonomous-agents',
      thumbnailUrl:
    ...
    },
    {
      ...
      workflowOverview:
        'AutoGen enables building applications with multiple agents that can converse with each other to solve tasks. Agents are customizable and can incorporate LLMs, tools, and human input.',
      useCase:
        'Build multi-agent systems where different AI agents collaborate, debate, and refine solutions together.',
    ...
    },
    {
      ...
      workflowOverview:
        'CrewAI allows you to create AI agent crews that work together on complex tasks. Define roles, goals, and let agents collaborate autonomously.',
      useCase:
        'Orchestrate teams of AI agents with specific roles (researcher, writer, editor) to complete sophisticated projects.',
    ...
    },
    {
      ...
      workflowOverview:
        'LangChain provides building blocks for LLM applications including chains, agents, memory, and tool integrations.',
      useCase:
        'Build sophisticated AI applications that combine language models with external data sources, APIs, and custom logic.',
      categorySlug: 'frameworks',
      thumbnailUrl:
    ...
    },
    {
      ...
      workflowOverview:
        'PydanticAI brings type-safe, validated AI agent development with Pydantic integration for reliable data handling.',
    ...
    },
    {
      ...
      workflowOverview:
        'MemGPT implements a virtual context management system that allows LLMs to have unlimited context through intelligent memory tiering.',
      useCase:
        'Build AI assistants that maintain long-term memory, remember past conversations, and manage context efficiently.',
    ...
    },
    {
      ...
      slug: 'autoagent',
      shortDescription:
        'Fully-Automated and Zero-Code framework for creating agents through Natural Language',
      workflowOverview:
        'AutoAgent allows you to create AI agents simply by describing what you want in natural language - no coding required.',
      useCase:
        'Create custom AI agents by describing their behavior in plain English, perfect for non-technical users.',
      categorySlug: 'low-code-no-code',
      thumbnailUrl:
    ...
    },
    {
      ...
      workflowOverview:
        'A visual platform built on LangChain for creating and managing AI agents through a web interface.',
      useCase:
        'Manage your LangChain agents through a user-friendly web dashboard with visual workflow builders.',
    ...
    },
    {
      ...
      slug: 'n8n',
      shortDescription:
        'Classic open-source tool for agentic automation with hundreds of integrations',
      workflowOverview:
        'n8n is a workflow automation platform with a visual editor, supporting AI agents and 400+ integrations.',
      useCase:
        'Create automated workflows combining AI agents with hundreds of apps and services through a visual builder.',
      categorySlug: 'low-code-no-code',
      thumbnailUrl:
    ...
    },
    {
      ...
      slug: 'langflow',
      shortDescription:
        'Mature visual platform for building LangChain applications with active community',
      workflowOverview:
        'LangFlow provides a drag-and-drop interface for building LangChain applications and AI agents visually.',
      useCase:
        'Design complex AI workflows by connecting components visually, then export to Python code.',
      categorySlug: 'low-code-no-code',
      thumbnailUrl:
    ...
    },
    {
      ...
      slug: 'owl',
      shortDescription:
        'Multi-agent collaboration framework built on CAMEL-AI, tops GAIA benchmark',
      workflowOverview:
        'OWL is a state-of-the-art multi-agent framework achieving top performance on agent benchmarks.',
      useCase:
        'Deploy high-performance multi-agent systems for complex reasoning and task completion.',
    ...
    },
    {
      ...
      slug: 'agentdock',
      shortDescription:
        'Open-source foundation to build, manage, and deploy production-ready AI agents',
      workflowOverview:
        'AgentDock provides infrastructure for deploying and managing AI agents at scale in production environments.',
      useCase:
        'Deploy and manage production AI agents with monitoring, scaling, and enterprise features.',
      categorySlug: 'platforms-hubs',
      thumbnailUrl:
    ...
    },
    {
      ...
      slug: 'modus',
      shortDescription:
        'Open source serverless framework for building intelligent agents in Go or AssemblyScript',
      workflowOverview:
        'Modus enables building serverless AI agents using Go or AssemblyScript for high-performance applications.',
    ...
    },
    {
      ...
      slug: 'gobii',
      shortDescription:
        'Open-source platform for deploying and managing browser-use agents at scale',
      workflowOverview:
        'Gobii specializes in browser automation agents, allowing AI to interact with web applications like a human user.',
      useCase:
        'Deploy AI agents that can browse websites, fill forms, extract data, and automate web-based tasks.',
    ...
    },
    {
      ...
      slug: 'qwen3-tts',
      shortDescription:
        'Open-source TTS model with 3-second voice cloning, multilingual support (10 languages)',
      workflowOverview:
        'Qwen3-TTS provides state-of-the-art text-to-speech with instant voice cloning from just 3 seconds of audio.',
      useCase:
        'Add natural voice synthesis to your applications with support for voice cloning and 10 languages.',
    ...
    },
    {
      ...
      slug: 'memvid',
      shortDescription:
        'Portable serverless memory layer for AI agents stored as single file with Smart Frames',
      workflowOverview:
        'Memvid provides a unique memory solution storing agent memory as video files for efficient retrieval.',
      useCase:
        'Add persistent, portable memory to your AI agents that can be stored and transferred as single files.',
      categorySlug: 'memory-context',
      thumbnailUrl:
    ...
    },
    {
      ...
      slug: 'dify',
      shortDescription:
        'Low-code platform with visual interface, 93K GitHub stars, supports hundreds of LLMs',
      workflowOverview:
        'Dify is a popular LLM application development platform with visual workflow builders and extensive model support.',
      useCase:
        'Build AI applications visually with support for RAG, agents, and workflows across multiple LLM providers.',
      categorySlug: 'low-code-no-code',
      thumbnailUrl:
    ...
    },
    {
      ...
      workflowOverview:
        'Retell AI specializes in voice-based AI agents for call centers and customer service applications.',
      useCase:
        'Build AI voice agents that can handle phone calls, customer support, and sales conversations.',
      categorySlug: 'voice-speech',
      thumbnailUrl:
  ...
  // Insert agents with $14.99 pricing and featured images
  for (const agent of openSourceAgents) {
    ...
    await prisma.agent.upsert({
      ...
      update: {
        ...
        thumbnailUrl: agent.thumbnailUrl || null,
        price: 14.99,
      },
      create: {
